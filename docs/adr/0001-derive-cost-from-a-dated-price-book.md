...
Up to 1.0.6, each row's cost was computed at scan time and frozen in SQLite, and a models.dev catalog fetched at runtime sat between the overrides and a Swift rate table. Two problems made us drop both:
